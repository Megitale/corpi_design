        ...
        if (!resetPlacement) {
          switch (fallbackStrategy) {
            case "bestFit": {
              ...
              const placement2 = (_overflowsData$map$so = overflowsData.map((d12) => [d12.placement, d12.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)]).sort((a18, b6) => a18[1] - b6[1])[0]) == null ? void 0 : _overflowsData$map$so[0];
              if (placement2) {
        ...
        onScroll() {
          ...
          if (prevScrollTopRef.current !== null) {
            ...
            if (overflowRef.current.bottom < -0.5 && scrollDiff < -1 || overflowRef.current.top < -0.5 && scrollDiff > 1) {
              (0, import_react_dom5.flushSync)(() => onChange((d12) => d12 + scrollDiff));
            }
          }
          requestAnimationFrame(() => {
            prevScrollTopRef.current = el.scrollTop;
...
var N4 = I(function(r17, l16) {
  ...
  }), b6 ? !a18 || !t12 ? null : (0, import_react_dom6.createPortal)(H({ ourProps: { ref: n13 }, theirProps: e7, slot: {}, defaultTag: M3, name: "Portal" }), t12) : null;
});
function S6(p7, r17) {
...
function Mo(o19, r17) {
  ...
  let v6 = (0, import_react81.useRef)(false), y10 = o4(() => {
    ...
    switch (t12.setIsTyping(true), l16.key) {
      ...
      case o8.ArrowUp:
        return l16.preventDefault(), l16.stopPropagation(), u2(e7.comboboxState, { [0]: () => t12.goToOption(c9.Previous), [1]: () => {
          (0, import_react_dom7.flushSync)(() => t12.openCombobox()), e7.value || t12.goToOption(c9.Last);
        } });
      case o8.Home:
    ...
    var S8, H10, x8;
    let U5 = (S8 = l16.relatedTarget) != null ? S8 : t8.find((L8) => L8 !== l16.currentTarget);
    (H10 = e7.buttonRef.current) != null && H10.contains(U5) || (x8 = e7.optionsRef.current) != null && x8.contains(U5) || e7.disabled || e7.immediate && e7.comboboxState !== 0 && ((0, import_react_dom7.flushSync)(() => t12.openCombobox()), t12.setActivationTrigger(1));
...
function Vo(o19, r17) {
  ...
  let e7 = oe("Combobox.Button"), t12 = re("Combobox.Button"), c14 = y(e7.buttonRef, r17), d12 = (0, import_react46.useId)(), { id: f20 = `headlessui-combobox-button-${d12}`, disabled: s14 = e7.disabled || false, autoFocus: u17 = false, ...a18 } = o19, n13 = f10(e7.inputRef), T10 = o4((O5) => {
    switch (O5.key) {
      case o8.Space:
      case o8.Enter:
        O5.preventDefault(), O5.stopPropagation(), e7.comboboxState === 1 && (0, import_react_dom7.flushSync)(() => t12.openCombobox()), n13();
        return;
      case o8.ArrowDown:
        O5.preventDefault(), O5.stopPropagation(), e7.comboboxState === 1 && ((0, import_react_dom7.flushSync)(() => t12.openCombobox()), e7.value || t12.goToOption(c9.First)), n13();
        return;
      case o8.ArrowUp:
        O5.preventDefault(), O5.stopPropagation(), e7.comboboxState === 1 && ((0, import_react_dom7.flushSync)(() => t12.openCombobox()), e7.value || t12.goToOption(c9.Last)), n13();
        return;
      case o8.Escape:
        if (e7.comboboxState !== 0) return;
        O5.preventDefault(), e7.optionsRef.current && !e7.optionsPropsRef.current.static && O5.stopPropagation(), (0, import_react_dom7.flushSync)(() => t12.closeCombobox()), n13();
        return;
      default:
        return;
    }
...
function Dt2(e7, r17) {
  ...
  let o19 = Q("Listbox.Button"), n13 = J5("Listbox.Button"), a18 = (0, import_react46.useId)(), O5 = u5(), { id: v6 = O5 || `headlessui-listbox-button-${a18}`, disabled: i15 = o19.disabled || false, autoFocus: s14 = false, ...p7 } = e7, t12 = y(o19.buttonRef, r17, ye()), u17 = Fe(), b6 = o4((g6) => {
    switch (g6.key) {
      ...
      case o8.Space:
      case o8.ArrowDown:
        g6.preventDefault(), (0, import_react_dom8.flushSync)(() => n13.openListbox()), o19.value || n13.goToOption(c9.First);
        break;
      case o8.ArrowUp:
        g6.preventDefault(), (0, import_react_dom8.flushSync)(() => n13.openListbox()), o19.value || n13.goToOption(c9.Last);
        break;
    }
  }), c14 = o4((g6) => {
    switch (g6.key) {
    ...
    o19.listboxState === 0 ? ((0, import_react_dom8.flushSync)(() => n13.closeListbox()), (d12 = o19.buttonRef.current) == null || d12.focus({ preventScroll: true })) : (g6.preventDefault(), n13.openListbox());
  ...
  let d12 = o4((l16) => {
    ...
    switch (g6.dispose(), l16.key) {
      ...
      case o8.Enter:
        ...
        t12.mode === 0 && ((0, import_react_dom8.flushSync)(() => u17.closeListbox()), (C7 = t12.buttonRef.current) == null || C7.focus({ preventScroll: true }));
        break;
      ...
      case o8.Escape:
        l16.preventDefault(), l16.stopPropagation(), (0, import_react_dom8.flushSync)(() => u17.closeListbox()), (A9 = t12.buttonRef.current) == null || A9.focus({ preventScroll: true });
        return;
      case o8.Tab:
        l16.preventDefault(), l16.stopPropagation(), (0, import_react_dom8.flushSync)(() => u17.closeListbox()), j3(t12.buttonRef.current, l16.shiftKey ? F.Previous : F.Next);
        break;
      default:
...
function Mt(e7, r17) {
  ...
  let k4 = o4((T10) => {
    ...
    p7.onChange(O5), s14.mode === 0 && ((0, import_react_dom8.flushSync)(() => p7.closeListbox()), (h8 = s14.buttonRef.current) == null || h8.focus({ preventScroll: true }));
  }), _5 = o4(() => {
...
function et(e7, a18) {
  ...
  let r17 = (0, import_react46.useId)(), { id: i15 = `headlessui-menu-button-${r17}`, disabled: o19 = false, autoFocus: l16 = false, ...p7 } = e7, [n13, u17] = B2("Menu.Button"), c14 = Fe(), t12 = y(n13.buttonRef, a18, ye()), d12 = o4((g6) => {
    switch (g6.key) {
      ...
      case o8.Enter:
      case o8.ArrowDown:
        g6.preventDefault(), g6.stopPropagation(), (0, import_react_dom9.flushSync)(() => u17({ type: 0 })), u17({ type: 2, focus: c9.First });
        break;
      case o8.ArrowUp:
        g6.preventDefault(), g6.stopPropagation(), (0, import_react_dom9.flushSync)(() => u17({ type: 0 })), u17({ type: 2, focus: c9.Last });
        break;
    }
  }), f20 = o4((g6) => {
    switch (g6.key) {
    ...
    var h8;
    if (r5(g6.currentTarget)) return g6.preventDefault();
    o19 || (n13.menuState === 0 ? ((0, import_react_dom9.flushSync)(() => u17({ type: 1 })), (h8 = n13.buttonRef.current) == null || h8.focus({ preventScroll: true })) : (g6.preventDefault(), u17({ type: 0 })));
...
function rt(e7, a18) {
  ...
  let w9 = p(), M8 = o4((s14) => {
    ...
    switch (w9.dispose(), s14.key) {
      ...
      case o8.Escape:
        s14.preventDefault(), s14.stopPropagation(), (0, import_react_dom9.flushSync)(() => d12({ type: 1 })), ($5 = t12.buttonRef.current) == null || $5.focus({ preventScroll: true });
        break;
      case o8.Tab:
        s14.preventDefault(), s14.stopPropagation(), (0, import_react_dom9.flushSync)(() => d12({ type: 1 })), j3(t12.buttonRef.current, s14.shiftKey ? F.Previous : F.Next);
        break;
      default:
